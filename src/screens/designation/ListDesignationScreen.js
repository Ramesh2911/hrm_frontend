...
import ListDesignation from '../../components/designation/ListDesignation';

const ListDesignationScreen = (props) => {
                     ...
                     <div className="row align-items-center">
                        <div className="col-md-6">
                           <div className="page-header-title">
                              <h5 className="m-b-10">Designation</h5>
                           </div>
                        </div>
...
export default ListDesignationScreen;
